...
void drawControlPanel() {
  ...
  // create labels
  label_serialOut = new GLabel(this, "Serial Out:           ", 310, 475, 150, 20);
  label_serialOut.localColor.lblFont = color(0,255,0);
  ...
  label_targetY = new GLabel(this, "Tilt Servo Position:    ", 310, 515, 150, 20);
  label_targetY.localColor.lblFont = color(0,255,0);
  label_targetY.setBorder(0);
  label_targetY.setOpaque(false);
  panel_main.add(label_targetY);	

  label_fire = new GLabel(this, "Not Firing", 310, 535, 150, 20);
  //label_fire.setColorScheme(GCScheme.GREEN_SCHEME);
  label_fire.localColor.lblFont = color(0,255,0);
  label_fire.setBorder(0);
  label_fire.setOpaque(false); 
  panel_main.add(label_fire);	

  label_fireSelector = new GLabel(this, "Automatic", 310, 555, 150, 20);
  label_fireSelector.localColor.lblFont = color(0,255,0);
  ...
  label_xMin.localColor.lblFont = color(0,255,0);
  ...
  label_xMax.localColor.lblFont = color(0,255,0);
  ...
  label_yMin.localColor.lblFont = color(0,255,0);
  ...
  label_yMax.localColor.lblFont = color(0,255,0);
  ...
  checkbox_showRestrictedZones.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_trackingColor.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_safeColor.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_trackingMotion.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_showDifferentPixels.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_showTargetBox.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_mirrorCam.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_controlMode.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_safety.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_showCameraView.localColor.cbxFont = color(0,255,0);
  ...
  checkbox_useArrowKeys.localColor.cbxFont = color(0,255,0);
  ...
  // create buttons
  button_viewCameraSettings = new GButton(this, "Webcam Settings", 385, 95, 120, 10);
  ...
  button_loadSettings = new GButton(this, "Re-Load Settings", 460, 120, 120, 10);
  ...
  //slider_tolerance.setFontColour(0,255,0);
  ...
  label_slider_tolerance.localColor.lblFont = color(0,255,0);
  ...
  label_slider_trackColorTolerance.localColor.lblFont = color(0,255,0);
  ...
  label_slider_safeColorTolerance.localColor.lblFont = color(0,255,0);
  ...
  label_slider_safeColorMinSize.localColor.lblFont = color(0,255,0);
  ...
  label_slider_minBlobArea.localColor.lblFont = color(0,255,0);
  ...
  label_slider_nbDot.localColor.lblFont = color(0,255,0);
  ...
  label_slider_antSens.localColor.lblFont = color(0,255,0);
  ...
  label_slider_propX.localColor.lblFont = color(0,255,0);
  ...
  label_slider_propY.localColor.lblFont = color(0,255,0);
  ...
  label_smoothingFactor.localColor.lblFont = color(0,255,0);
